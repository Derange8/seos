...
INSERT INTO "new_ai_visibility_probe_runs" ("id", "outcomes", "projectId", "runAt", "samplesPerQuery") SELECT "id", "outcomes", "projectId", "runAt", "samplesPerQuery" FROM "ai_visibility_probe_runs";
