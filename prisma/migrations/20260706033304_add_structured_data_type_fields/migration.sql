...
INSERT INTO "new_pages" ("canonicalTagCount", "canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "cspHeader", "externalScriptOrigins", "faqs", "h1", "h1Count", "hasDuplicateContent", "hasDuplicateMetaDescription", "hasDuplicateTitle", "hasStructuredData", "id", "imagesMissingAltCount", "isClientSideOnlyContent", "isNoindex", "isOrphan", "metaDescription", "mixedContentCount", "projectId", "rawWordCount", "redirectChain", "responseTimeMs", "statusCode", "title", "url", "wordCount") SELECT "canonicalTagCount", "canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "cspHeader", "externalScriptOrigins", "faqs", "h1", "h1Count", "hasDuplicateContent", "hasDuplicateMetaDescription", "hasDuplicateTitle", "hasStructuredData", "id", "imagesMissingAltCount", "isClientSideOnlyContent", "isNoindex", "isOrphan", "metaDescription", "mixedContentCount", "projectId", "rawWordCount", "redirectChain", "responseTimeMs", "statusCode", "title", "url", "wordCount" FROM "pages";
DROP TABLE "pages";
