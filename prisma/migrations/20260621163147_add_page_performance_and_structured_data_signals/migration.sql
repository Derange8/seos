...
INSERT INTO "new_pages" ("canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "id", "metaDescription", "projectId", "statusCode", "title", "url", "wordCount") SELECT "canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "id", "metaDescription", "projectId", "statusCode", "title", "url", "wordCount" FROM "pages";
DROP TABLE "pages";
