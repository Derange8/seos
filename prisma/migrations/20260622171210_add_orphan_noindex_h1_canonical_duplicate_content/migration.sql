...
INSERT INTO "new_pages" ("canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "hasDuplicateMetaDescription", "hasDuplicateTitle", "hasStructuredData", "id", "imagesMissingAltCount", "metaDescription", "mixedContentCount", "projectId", "redirectChain", "responseTimeMs", "statusCode", "title", "url", "wordCount") SELECT "canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "hasDuplicateMetaDescription", "hasDuplicateTitle", "hasStructuredData", "id", "imagesMissingAltCount", "metaDescription", "mixedContentCount", "projectId", "redirectChain", "responseTimeMs", "statusCode", "title", "url", "wordCount" FROM "pages";
DROP TABLE "pages";
