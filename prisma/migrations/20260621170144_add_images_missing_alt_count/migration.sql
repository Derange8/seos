...
INSERT INTO "new_pages" ("canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "hasStructuredData", "id", "metaDescription", "projectId", "responseTimeMs", "statusCode", "title", "url", "wordCount") SELECT "canonicalUrl", "contentExcerpt", "contentHash", "crawlJobId", "crawledAt", "faqs", "h1", "hasStructuredData", "id", "metaDescription", "projectId", "responseTimeMs", "statusCode", "title", "url", "wordCount" FROM "pages";
DROP TABLE "pages";
